...
- `transformer.type`: Transformer implementation (ORIGINAL_TRANSFORMER / OPENAI_GPT_1 / OPENAI_GPT_2 / BIG_SCIENCE_BLOOM / ELEUTHERAI_GPT_NEO / ELEUTHERAI_GPT_J / META_LLAMA)
